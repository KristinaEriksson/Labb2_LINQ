...
namespace Labb2_LINQ.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public TeacherController(ForzaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Teachers != null ? 
                          ...
                          Problem("Entity set 'ForzaDbContext.Teachers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ForzaDbContext.Teachers'  is null.");
            }
            var teacher = await _context.Teachers.FindAsync(id);
            if (teacher != null)
            {
